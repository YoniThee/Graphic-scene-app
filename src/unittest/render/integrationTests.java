...
class integrationTests {
	...
	void intersectionIntegration() {
		...
		assertEquals(2,countIntersections(sphere1,camera1, 3, 3),
				"BadRay" );
		...
		assertEquals(18,countIntersections(sphere2, camera2, 3, 3), "BadRay");
		...
		assertEquals(10, countIntersections(sphere3, camera3, 3, 3),"BadRay");


		//TC04: checking all view plan inside the sphere
		Sphere sphere4 = new Sphere(new Point(0,0,-2),4);
		Camera camera4 = new Camera(new Point(0,0,-1), new Vector(0,0,-1),new Vector(0,1,0));
		assertEquals(9, countIntersections(sphere4, camera4, 3, 3),"BadRay");
		...
		assertEquals(0, countIntersections(sphere5, camera5, 3, 3),"BadRay");
		...
		Camera camera6 = new Camera(new Point(0,0,0),new Vector(0,0,-1),new Vector(0,1,0));
		assertEquals(9,countIntersections(plane6, camera6, 3, 3),  "BadRay");
		...
		Camera camera7 = new Camera(new Point(0,0,1), new Vector(0,0,-1),new Vector(0,1,0));
		assertEquals(9,countIntersections(plane7, camera7, 3, 3),  "BadRay");
		...
		Camera camera8 = new Camera(new Point(0,0,2), new Vector(0,0,-1),new Vector(0,1,0));
		assertEquals(6,countIntersections(plane8, camera8, 3, 3),  "BadRay");
		...
		Camera camera9 = new Camera(new Point(0,0,2), new Vector(0,0,-1),new Vector(0,1,0));
		assertEquals(1,countIntersections(triangle9, camera9, 3, 3),  "BadRay");
		...
		Camera camera10 = new Camera(new Point(0,0,2),new Vector(0,0,-1),new Vector(0,1,0));

		assertEquals(2,countIntersections(triangle10, camera10, 3, 3),  "BadRay");
